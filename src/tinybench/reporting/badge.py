"""Badge generation for TinyBench results.
...
def edge_score_badge_url(result: BenchmarkResult) -> str:
    ...
    label = quote("TinyBench Edge Score")
...
def generate_badge_markdown(result: BenchmarkResult) -> str:
    ...
    Example output:
        ![TinyBench Edge Score](https://img.shields.io/badge/...) ![tok/s](...)
    """
    parts = []

    # Edge Score badge
    score_url = edge_score_badge_url(result)
    parts.append(f"![TinyBench Edge Score]({score_url})")
